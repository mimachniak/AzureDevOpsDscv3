...
DscResourcesToExport = @('ProjectResource', 'OrganizationUserResource', 'OrganizationGroupResource', 'ProjectUserPermissionResource', 'ProjectGroupPermissionResource', 'OrganizationUserPermissionResource', 'OrganizationGroupPermissionResource')
...
# Private data to pass to the module specified in RootModule/ModuleToProcess. This may also contain a PSData hashtable with additional module metadata used by PowerShell.
    PrivateData      = @{
        PSData = @{
            ...
            v. 1.0.2 - 2026-06-01
                - Fix issue and docs and native DSC resources
            v. 1.0.3 - 2026-06-12
